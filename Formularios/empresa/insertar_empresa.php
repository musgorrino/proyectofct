...
<form action="" method="post">
	<table>
		...
		<tr>
			...
			<td><label for="provincia">provincia: </label>d>
		...
		<tr>
		<td><input type="reset" id="limpiar" name="limpiar" value="Limpiar" />
		<input type="submit" id="enviar" name="enviar" value="Crear" /><td>
		</tr>
</table>
</form>
</body>
